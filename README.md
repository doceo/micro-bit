...
> Apri questa pagina in [https://doceo.github.io/micro-bit/](https://doceo.github.io/micro-bit/)
...
* cerca **https://github.com/doceo/micro-bit** ed importa

## Modifica questo progetto ![Badge stato build](https://github.com/doceo/micro-bit/workflows/MakeCode/badge.svg)

Per modificare questa repository in MakeCode.

* apri [https://makecode.microbit.org/](https://makecode.microbit.org/)
* clicca su **Importa** quindi fai clic su **Importa INDIRIZZO**
* incolla **https://github.com/doceo/micro-bit** e clicca importa
...
![Un'immagine renderizzata dei blocchi](https://github.com/doceo/micro-bit/raw/master/.github/makecode/blocks.png)
